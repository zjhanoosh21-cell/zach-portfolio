...
| [Sage — Personal Finance Advisor](projects/sage-finance-advisor/) | Local-first finance app with a Claude-powered advisor that updates your accounts, budget, and goals directly from conversation (streaming + tool use). **[Hosted preview](https://zach-sage-demo.vercel.app)** with fictional data (advisor disabled there) | Next.js, Prisma, Anthropic SDK, Recharts, Tailwind v4 | Personal project, **in progress** |
